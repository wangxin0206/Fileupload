                                ...
                                <div class="table-wrap">
                                    <table id="footable_2" class="table" data-paging="true" data-filtering="true" data-sorting="true">
                                        ...
                                        <%
                                            ...
                                            ArrayList<EntityDic> list = (ArrayList<EntityDic>)dao.selectdata(tablename);
                                        ...
                                        <div class="modal-dialog" role="document">
                                            <form action="/UpdateDicServlet" class="modal-content form-horizontal" id="editor">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <div class="form-group">
                                                        <label for="dob" class="col-sm-3 control-label">主外键</label>
                                                        <div class="col-sm-9">
                                                            <input type="text" class="form-control" id="dob" name="dob" placeholder="主外键">
                                                        </div>
                                                    </div>
                                                </div>
