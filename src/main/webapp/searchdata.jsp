                ...
                <div class="col-sm-12">
                    <div class="panel panel-default card-view">
                        <div class="panel-heading">
                            <div class="pull-left">
                                <h6 class="panel-title txt-dark">筛选结果显示-条件-预算、受欢迎、评分非0，评分人数大与50</h6>
                            </div>
                        </div>
                                    ...
                                    <div class="table-responsive">
                                        <table id="datable_1" class="table table-hover display  pb-30">
                                            ...
                                            <%
                                                ...
                                                List<Filestatus> li4 = dao.selectingreaserch();
                                                int num = dao.selectReaserchNum();
                                                %>
                                                <tr>
                                                    经筛选，结果共<%=num%>条
                                                </tr>
                                            <%
                                                for(Filestatus bi : li4){
                                            %>

                                            <tr>
                                                <td><%=bi.getFilename()%></td>
                                                <td><%=bi.getFiletype()%></td>
                                                <td><%=bi.getFilepath()%></td>
                                                <td><%=bi.getName1()%></td>
                                                <td><%=bi.getName2()%></td>
                                                <td><%=bi.getName3()%></td>
                                                <td><%=bi.getName4()%></td>
