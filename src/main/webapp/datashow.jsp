...
<head>
    ...
    <!-- Footable CSS -->
    <link href="static/css/jsgrid.min.css" rel="stylesheet" type="text/css">
    <link href="static/css/jsgrid-theme.min.css" rel="stylesheet" type="text/css">
    <!-- Custom CSS -->
        ...
        <div class="container-fluid">
            ...
            <div class="row heading-bg bg-green">
                <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                    <h5 class="txt-light">Data table</h5>
                </div>
            </div>
            <!-- /Title -->
           <div class="row">
           ...
           <%--<div class="row">
                <div class="col-sm-12">
                    <div class="panel panel-default card-view">
                        <div class="panel-heading">
                            <div class="pull-left">
                                <h6 class="panel-title txt-dark">缺失id为<%=request.getAttribute("id")%>缺失字段为<%=request.getAttribute("name")%>-------共4803条数据</h6>
                            </div>
                            <div class="clearfix"></div>
                        </div>
                        <div class="panel-wrapper collapse in">
...
<script src="static/js/jsgrid-data.js"></script>
