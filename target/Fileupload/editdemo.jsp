...
<div class="wrapper">
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top">
        ...
        <a href="index.html"><img class="brand-img pull-left" src="static/picture/logo.png" alt="brand"></a>
        <ul class="nav navbar-right top-nav pull-right">
                        ...
                        <div class="streamline message-box message-nicescroll-bar">
                            <div class="sl-item">
                                <div class="sl-avatar avatar avatar-sm avatar-circle">
                                    <img class="img-responsive img-circle" src="static/picture/user.png" alt="avatar">
                                </div>
                            ...
                            <div class="sl-item">
                                <div class="sl-avatar avatar avatar-sm avatar-circle">
                                    <img class="img-responsive img-circle" src="static/picture/user4.png" alt="avatar">
                                </div>
                                <div class="sl-content">
                                    <a href="javascript:void(0)" class="inline-block capitalize-font  pull-left">Sandy Doe</a>
                                    <span class="inline-block font-12  pull-right">1pm</span>
            ...
            <li class="dropdown">
                <a href="#" class="dropdown-toggle pr-0" data-toggle="dropdown"><img src="static/picture/user4.png" alt="user_auth" class="user-auth-img img-circle"><span class="user-online-status"></span></a>
    ...
    <div class="fixed-sidebar-left">
        <ul class="nav navbar-nav side-nav nicescroll-bar">
            ...
            <li>
                <a class="active" href="javascript:void(0);" data-toggle="collapse" data-target="#table_dr"><i class="icon-list mr-10"></i>Tables<span class="pull-right"><i class="fa fa-fw fa-angle-down"></i></span></a>
                <ul id="table_dr" class="collapse collapse-level-1">
                    ...
                    <li>
                        <a class="active" href="">Editable Table</a>
                    </li>
                    <li>
                                    ...
                                    <li class="chat-list">
                                        <div class="chat-body">
                                            <a href="javascript:void(0)">
                                                <div class="chat-data">
                                                    <img class="user-img img-circle" src="static/picture/user.png" alt="user">
                                                    <div class="user-data">
                                            ...
                                            <a href="javascript:void(0)">
                                                <div class="chat-data">
                                                    <img class="user-img img-circle" src="static/picture/user4.png" alt="user">
                                                    <div class="user-data">
                                                        <span class="name block capitalize-font">ryan gosling</span>
        ...
        <div class="container-fluid">
            ...
            <div class="row heading-bg bg-green">
                <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                    <h5 class="txt-light">Editable table</h5>
                </div>
                <!-- Breadcrumb -->
...
<script src="static/js/numeric-input-example.js"></script>
<script src="static/js/editable-table-data.js"></script>
<!-- Moment JavaScript -->
<script type="text/javascript" src="static/js/moment-with-locales.min.js"></script>
<script type="text/javascript" src="static/js/bootstrap-editable.min.js"></script>
<!-- Form-xeditable Init JavaScript -->
<script src="static/js/form-xeditable-data.js"></script>
